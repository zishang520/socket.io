...
set "MODULES=parsers/engine parsers/socket servers/engine servers/socket adapters/adapter adapters/postgres adapters/redis adapters/unix clients/engine clients/socket"
