...
set "MODULES=parsers/engine parsers/socket servers/engine servers/socket adapters/adapter adapters/mongo adapters/postgres adapters/redis adapters/unix adapters/valkey clients/engine clients/socket"
