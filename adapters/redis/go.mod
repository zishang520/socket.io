...
require (
	...
	github.com/zishang520/socket.io/adapters/adapter/v3 v3.0.0-alpha.2
	github.com/zishang520/socket.io/parsers/socket/v3 v3.0.0-alpha.2
	github.com/zishang520/socket.io/servers/socket/v3 v3.0.0-alpha.2
