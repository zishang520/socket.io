...
require (
	...
	github.com/zishang520/socket.io/adapters/adapter/v3 v3.0.0-alpha.3
	github.com/zishang520/socket.io/parsers/socket/v3 v3.0.0-alpha.3
	github.com/zishang520/socket.io/servers/socket/v3 v3.0.0-alpha.3
	github.com/zishang520/socket.io/v3 v3.0.0-alpha.3
)
...
require (
	...
	github.com/zishang520/socket.io/parsers/engine/v3 v3.0.0-alpha.3 // indirect
	github.com/zishang520/socket.io/servers/engine/v3 v3.0.0-alpha.3 // indirect
