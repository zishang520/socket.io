...
require (
	...
	github.com/zishang520/socket.io/adapters/adapter/v3 v3.0.0-alpha.4
	github.com/zishang520/socket.io/parsers/socket/v3 v3.0.0-alpha.4
	github.com/zishang520/socket.io/servers/socket/v3 v3.0.0-alpha.4
	github.com/zishang520/socket.io/v3 v3.0.0-alpha.4
)
...
require (
	...
	github.com/zishang520/socket.io/parsers/engine/v3 v3.0.0-alpha.4 // indirect
	github.com/zishang520/socket.io/servers/engine/v3 v3.0.0-alpha.4 // indirect
