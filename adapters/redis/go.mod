...
require (
	...
	github.com/zishang520/socket.io/adapters/adapter/v3 v3.0.0-beta.1
	github.com/zishang520/socket.io/parsers/socket/v3 v3.0.0-beta.1
	github.com/zishang520/socket.io/servers/socket/v3 v3.0.0-beta.1
	github.com/zishang520/socket.io/v3 v3.0.0-beta.1
)
...
require (
	...
	github.com/zishang520/socket.io/parsers/engine/v3 v3.0.0-beta.1 // indirect
	github.com/zishang520/socket.io/servers/engine/v3 v3.0.0-beta.1 // indirect
